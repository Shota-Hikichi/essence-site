  ...
  minimum: {
    ...
    features: [
      ...
      },
      {
        ...
        title: '月1回の電話相談',
        desc: '月に1回、30分の電話で学習状況を確認。進捗に応じた戦略の微調整を行います。',
  ...
  standard: {
    ...
    features: [
      ...
      },
      {
        ...
        title: '月2回の電話相談',
        desc: '隔週で45分の電話相談を実施。学習進捗の確認と戦略の見直しを丁寧に行います。',
  ...
  fullcommit: {
    ...
    features: [
      ...
      },
      {
        ...
        title: '月次進捗レポート',
        desc: '月末に詳細な進捗レポートを作成。保護者の方への共有にもお使いいただけます。',
        details: ['科目別の到達度分析', '前月との成長比較', '翌月の戦略提案', '保護者向け共有フォーマット'],
        highlighted: true,
        badge: 'フルコミット限定',
      },
    ],
