import HeroBgT4 from '@/components/HeroBg_T4';
import Link from 'next/link';

export default function TestT4() {
  return (
    <>
      <div style={{ position: 'fixed', bottom: '20px', left: '20px', zIndex: 9999, display: 'flex', gap: '8px' }}>
        ...
        <Link href="/test-bg/t5" style={{ padding: '10px 20px', background: '#9A071A', color: '#fff', borderRadius: '8px', fontSize: '13px', fontWeight: 700 }}>次へ: T5</Link>
      </div>
