import HeroBgP3 from '@/components/HeroBg_P3';
import Link from 'next/link';

export default function TestP3() {
  return (
    <>
      <div style={{ position: 'fixed', bottom: '20px', left: '20px', zIndex: 9999, display: 'flex', gap: '8px' }}>
        ...
        <Link href="/test-bg/p4" style={{ padding: '10px 20px', background: '#9A071A', color: '#fff', borderRadius: '8px', fontSize: '13px', fontWeight: 700 }}>次へ: P4</Link>
      </div>
