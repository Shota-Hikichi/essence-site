import HeroBgPatternB from '@/components/HeroBg_PatternB';
  ...
  return (
    <>
      <div style={{ position: 'fixed', bottom: '20px', left: '20px', zIndex: 9999, display: 'flex', gap: '8px' }}>
        ...
        <Link href="/test-bg/c" style={{ padding: '10px 20px', background: '#9A071A', color: '#fff', borderRadius: '8px', fontSize: '13px', fontWeight: 700 }}>次: C</Link>
      </div>
